...
assert.throws(() => assertSensitiveExportScopeAllowed(organization, { scopeType: "organization", scopeId: "org-1" }), /权限/);
assert.throws(() => assertSensitiveExportScopeAllowed(organization, { scopeType: "project", scopeId: "project-2", projectResponsibleOrganizationId: "org-1" }), /权限/);
assert.throws(() => assertSensitiveExportScopeAllowed(project, { scopeType: "project", scopeId: "project-1", projectResponsibleOrganizationId: "org-2" }), /权限/);
assert.throws(() => assertSensitiveExportScopeAllowed(organization, { scopeType: "organization", scopeId: "org-2" }), /权限/);
assert.throws(() => assertSensitiveExportScopeAllowed(project, { scopeType: "project", scopeId: "project-2", projectResponsibleOrganizationId: "org-2" }), /权限/);
