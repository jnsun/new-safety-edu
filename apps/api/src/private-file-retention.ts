...
export async function orphanPrivateFiles(db: PrismaClient, olderThan: Date) {
  const rows = await db.privateFile.findMany({ where: { createdAt: { lt: olderThan }, personPhotos: { none: {} }, personPhotoHistory: { none: {} }, versions: { none: {} }, coursewareVersionAssets: { none: {} }, signatures: { none: {} }, personCertificates: { none: {} }, organizationQualifications: { none: {} }, certificateAttachments: { none: {} }, monthlyReportAttachments: { none: {} }, receivableAttachments: { none: {} }, receivableImportBatches: { none: {} } }, select: { id: true, storageKey: true, size: true } });
  const unused = [];
